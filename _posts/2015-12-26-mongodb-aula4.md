...
<img alt="Mão digitando rápido" src="{{ "/assets/img/mongodb-update/digitando-rapido.gif"}}">
...
<img title="O que tá acontecendo?" alt="O cachorro não faz ideia do ta acontecendo" src="{{ "/assets/img/mongodb-update/i-have-no-idea.gif"}}">
...
E é isso, agora se divirta treinando modificando seus dados usando todos os operadores, tenta criar atualizações de vários dados simultâneos com javascript, até a próxima!
