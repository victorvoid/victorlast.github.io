...
<img src="{{ "/assets/img/garbage-collector/simpson-lixeira.jpg"}}" alt="Homer Simpson como lixeiro">
...
<img src="{{ "/assets/img/garbage-collector/simpson-game.gif"}}" alt="Homer Simpson jogando fiperama e comendo pizza ao mesmo tempo">
