...
Adoro o Sublime Text pela sua leveza, plugins e a total possibilidades de modificar-lo com temas
...
##Livro:
<img src="{{ "/assets/img/memes/bart-reading.jpg"}}" class="img-responsive">
...
<img src="{{ "/assets/img/memes/bart-listening.gif"}}">
...
##Série:
<img src="{{ "/assets/img/memes/homer-hack.jpg"}}" class="img-responsive">

Preciso sempre me motivar, e acho que todo mundo precisa, motivação é coisa séria, e pra ajudar nisso, adoro ver séries que motivam, não só séries como filmes e palestras, um tempo atrás eu vi Mr.Robot, e quem gosta de segurança da informação, não pode deixar de ver, indico.
[Mr.Robot](http://www.imdb.com/title/tt4158110/): 

<img src="{{ "/assets/img/memes/mr-robot-poster.jpg"}}" class="img-responsive">
