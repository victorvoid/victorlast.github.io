...
<a title="Leverá para a página do mongodb para fazer o download" target="_blank" href="https://www.mongodb.org/downloads#production">Clique aqui</a>
...
Pra ficar melhor seu entendimento, leia: <a title="Será que devemos usar nosql?" href="http://tech.leroymerlin.com.br/devemos-usar-nosql-e-mongodb" target="_blank">Devo usar NoSQL e MongoDB?</a>
...
<img src= "/assets/img/mongodb123/dog-notebook.gif" alt="Cachorro digitando no notebook">
