...
<img src="{{ "/assets/img/group-aggregate/hc.gif"}}" alt="cachorro pegando vento forte no carro">
...
## Agrupamento
<img alt="Agrupamento de items" src="{{ "/assets/img/group-aggregate/elements-2.png"}}">
...
<img alt="cachorro rosnando para outro cachorro" src="{{ "/assets/img/group-aggregate/dog-mordida.gif"}}">
